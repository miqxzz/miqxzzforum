...
func (_m *PostRepository) GetPosts(ctx context.Context, limit int, offset int) ([]entity.Post, error) {
...
func (_m *PostRepository) GetTotalPostsCount(ctx context.Context) (int, error) {
	ret := _m.Called(ctx)
